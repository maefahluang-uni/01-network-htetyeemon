[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=20028289)
...
```
The `main()` method starts two mock web servers on ports 8080 and 8081 in separate threads, then waits for the user to press any key to stop the servers and exit the program.
...
```
change the port number in the constructor
create many instances with different ports
update the response string in the MockWebServer
parallel testing, load testing
```
